  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 bg-white/90 backdrop-blur-md border-t border-gray-200 shadow-lg md:hidden">
      <div className="flex justify-around items-center py-3">
        ...
        >
          <IoHomeOutline className="text-gray-800" size={25} />
          <span className="text-[12px] text-gray-600 mt-1 font-medium">
            Home
          </span>
        </Link>
        ...
        <Link
          ...
          className="flex flex-col items-center   hover:text-yellow-600 transition-colors duration-200"
        >
          <FaWhatsapp className="text-gray-800" size={25} />
          <span className="text-gray-600 text-[12px] mt-1 font-medium">
            Whatsapp
          </span>
        </Link>
        ...
        <Link
          ...
          className="flex flex-col items-center  hover:text-yellow-600 transition-colors  duration-200"
        >
          <RiMessengerLine className="text-gray-800" size={25} />
          <span className="text-gray-600 text-[12px] mt-1 font-medium">
            Messenger
          </span>
        </Link>
        ...
        >
          <IoCartOutline className="text-gray-800 " size={25} />
        ...
        <Link
          ...
          className="flex flex-col items-center  hover:text-yellow-600 transition-colors duration-200 "
        >
          <FaFacebookF className="text-gray-800" size={25} />
          <span className="text-gray-600 text-[12px] mt-1 font-medium">
            Facebook
          </span>
        </Link>
