...
const CategoryPage = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 xl:grid-rows-2 gap-2 ">
        {items.map((item, index) => (
          <div
            key={index}
            className={`w-full cursor-pointer ${item.span ? 'xl:row-span-2' : ''}`}
          >
            <div
